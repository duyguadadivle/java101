...
public class Guessing {
    public static void main(String[] args) {
        ...
        for(int right=0; right<5; right++){
            System.out.println("Please enter your guess between 0 and 100: ");
            ...
            if (selected == number){
                isWin = true;
                System.out.println("Congratulations correct guess " + "The secret number is: ");
                break;
            }
            else {
                System.out.println("You entered incorrect number");
                if (selected > number){
                    System.out.println("Your guess is bigger than secret number");
                }
                else {
